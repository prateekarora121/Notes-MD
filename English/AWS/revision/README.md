...
> Quick-revision notes derived from the AWS Interview Guide. Covers **every** section of the guide in the **same order** — condensed to Q&A + tight bullets, with the load-bearing code, tables, and diagrams preserved. Enough to brush up each topic without opening the full guide. Focus: nuance, trade-offs, "why", gotchas, interviewer follow-ups.
