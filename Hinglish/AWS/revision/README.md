...
> Yeh guide (`../Detailed Notes/K. AWS-Interview-Guide.md`) se derive ki gayi **quick-revision notes** hain — har section usi order mein, condensed **Q/A** aur tight bullets ke saath. Style deliberately Hinglish (Hindi+English Roman script) rakhi hai; technical terms/code English mein. Guide ke har topic/sub-topic ko cover kiya gaya hai taaki notes akele hi brush-up ke liye kaafi hon.

> Topic-wise split of the original single-file guide. Condensed/expanded counterpart: [Detailed Guide](../README.md).
